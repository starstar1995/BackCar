...
//28
		...
		{ XMFLOAT3(-1.0f, -3.0f, 1.0f), XMFLOAT3(0.0f, -3.0f, 0.0f), XMFLOAT2(0.0f, 1.0f) },
		{ XMFLOAT3(1.0f, -3.0f, -1.0f), XMFLOAT3(0.0f, -3.0f, 0.0f), XMFLOAT2(1.0f, 0.0f) },
		{ XMFLOAT3(1.0f, -3.0f, 1.0f), XMFLOAT3(0.0f, -3.0f, 0.0f), XMFLOAT2(1.0f, 1.0f) },
...
bool Display(float timeDelta  )
{
	if (device)
	{
		...
		if (::GetAsyncKeyState('A') & 0x8000f)
			transX -= 2.0f * timeDelta;
		if (::GetAsyncKeyState('D') & 0x8000f)
			transX += 2.0f * timeDelta;
		if (::GetAsyncKeyState('S') & 0x8000f)
			transZ -= 2.0f * timeDelta;
		if (::GetAsyncKeyState('W') & 0x8000f)
			transZ += 2.0f * timeDelta;

		/*if (transX >= 5.0f)transX = 5.0f;
		if (transX <+-5.0f)transX = -5.0f;
		if (transZ >= 2.0f)transZ = 2.0f;
		if (transZ <= -2.0f)transZ = -2.0f;*/
		...
		world = XMMatrixIdentity();
		world = XMMatrixTranslation(transX, 0.0f, transZ);
